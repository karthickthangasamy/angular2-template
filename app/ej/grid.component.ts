import {CreateArrayTagDirective, CreateControlValueAccessor, CreateComplexDirective, CreateComponent, Utils, ContentChild, Type, forwardRef, CreateTemplateDirective } from './core';
...
export var TemplateDirective = CreateTemplateDirective({
    selector: "[e-template]",
    inputs: [],
    queries: {
...
export var ColumnDirective = CreateComplexDirective({
    ...
    queries: {
        ...
        _template: new ContentChild(TemplateDirective)
    }
}, {
        tags: ["commands"],
        type: forwardRef(() => GridComponent)
